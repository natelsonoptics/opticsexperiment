...
if __name__ == '__main__':
    root = tk.Tk()
    fields = {'steps': 10}
    with pm100d.connect(hardware_addresses_and_constants.pm100d_address) as q, attenuator_wheel.create_do_task(hardware_addresses_and_constants.attenuator_wheel_outputs) as r:
