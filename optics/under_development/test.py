...
from optics.hardware_control import sr7270, npc3sg_analog, hardware_addresses_and_constants, polarizercontroller, pm100d

if __name__ == '__main__':
    root = tk.Tk()
    fields = {'file path': "", 'device': "", 'scan': 0, 'notes': "", 'gain': 1000, 'max time (s)': 600}
    ...
    with npc3sg_analog.create_ai_task(hardware_addresses_and_constants.ai_x, hardware_addresses_and_constants.ai_y) \
            ...
            polarizercontroller.connect_kdc101(hardware_addresses_and_constants.kdc101_serial_number) as \
                    polarizercontroller:
        try:
            thermovoltage_polarization_gui = SetupGUI(root, title, fields, npc3sg_input=npc3sg_input,
                                                      sr7270_bottom=sr7270_bottom,
                                                      polarizercontroller=polarizercontroller, powermeter=powermeter)
