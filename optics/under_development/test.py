...
class RamanTime:
    def __init__(self, master, filepath, notes, device, scan, ccd, grating, raman_gain, center_wavelength, units,
                 integration_time, acquisitions, shutter, darkcurrent, darkcorrected,  rate, maxtime, powermeter,
                 polarizer):
        self._master = master
