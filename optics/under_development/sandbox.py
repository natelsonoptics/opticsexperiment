...
class RamanLockinOutgoingPolarizationSweepBias():
    def __init__(self, master, filepath, notes, device, scan, gain, start_bias, stop_bias, bias_steps, osc,
                 ...
                 center_wavelength, raman_start, raman_stop, darkcurrent=False, darkcorrected=False):
    ...
    def main(self):
        for bias in self._biases:
            measurement = RamanLockinOutgoingPolarization(tk.Toplevel(self._master), self._filepath, self._notes, self._device, self._scan, bias,
